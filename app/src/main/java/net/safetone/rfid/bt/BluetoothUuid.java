...
public final class BluetoothUuid {
    ...
    public static final ParcelUuid SPP =
    		ParcelUuid.fromString("00001101-0000-1000-8000-00805F9B34FB");

    public static final ParcelUuid[] RESERVED_UUIDS = {
        AudioSink, AudioSource, AdvAudioDist, HSP, Handsfree, AvrcpController, AvrcpTarget,
        ObexObjectPush, MessageAccessServer, MessageNotificationServer, PANU, NAP, SPP};
    ...
    public static boolean isSpp(ParcelUuid uuid) {
        return uuid.equals(SPP);
    }
